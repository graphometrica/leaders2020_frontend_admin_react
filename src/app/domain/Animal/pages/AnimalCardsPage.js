...
import {AnimalStore, getAll} from '@domain/Animal/store/AnimalStore'

const AnimalCardsPage = ({ data, isFetching, getAllHandler
     }) => {
    
  return (
    <div>
        <AnimalCardsFilterBar />
        <AnimalCardsTable data={data} getAllHandler={getAllHandler} />
...
const AnimalCardsPageWrapper = (props) => {
  ...
  return <AnimalCardsPage  data={stub} isFetching={false} />;
};
